...
# The SOPC System ID 
# setting SOPC_SYSID is 29
SOPC_SYSID_FLAG += --id=29
ELF_PATCH_FLAG  += --id 29
...
# setting hal.stderr is jtag_uart_1d
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_1d

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_1d
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_1d
...
# setting hal.stdout is jtag_uart_1d
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_1d
