...
nios2-bsp hal $bsp_dir $sopc_file --cpu-name $cpu_name --set hal.timestamp_timer $timer_name --set hal.enable_reduced_device_drivers 1 --set hal.enable_small_c_library 1
