...
# CPU Name 
# setting CPU_NAME is CPU_1d_p1_sub_cpu_0
CPU_NAME = CPU_1d_p1_sub_cpu_0
...
# setting hal.stderr is CPU_1d_p1_uart_0
ELF_PATCH_FLAG  += --stderr_dev CPU_1d_p1_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is CPU_1d_p1_uart_0
ELF_PATCH_FLAG  += --stdin_dev CPU_1d_p1_uart_0
...
# setting hal.stdout is CPU_1d_p1_uart_0
ELF_PATCH_FLAG  += --stdout_dev CPU_1d_p1_uart_0
