...
# Memory: CPU_1c_p2_oc_ram_0
MEM_0 := FTOP_MSOC_CPU_1c_p2_oc_ram_0
$(MEM_0)_NAME := CPU_1c_p2_oc_ram_0
...
$(MEM_0)_END := 0x0000bbff
$(MEM_0)_SPAN := 0x00003c00
$(MEM_0)_HIERARCHICAL_PATH := CPU_1c_p2.oc_ram_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: CPU_1c_p2_oc_ram_0
CPU_1c_p2_oc_ram_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
