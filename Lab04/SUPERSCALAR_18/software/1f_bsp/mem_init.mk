...
# Memory: mem_info
MEM_0 := FTOP_MSOC_mem_info
$(MEM_0)_NAME := mem_info
...
$(MEM_0)_END := 0x000103ff
$(MEM_0)_SPAN := 0x00000400
$(MEM_0)_HIERARCHICAL_PATH := mem_info
$(MEM_0)_WIDTH := 32
...
.PHONY: mem_info
mem_info: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: oc_ram_1f
MEM_1 := FTOP_MSOC_oc_ram_1f
$(MEM_1)_NAME := oc_ram_1f
...
$(MEM_1)_END := 0x00058fff
$(MEM_1)_SPAN := 0x00019000
$(MEM_1)_HIERARCHICAL_PATH := oc_ram_1f
$(MEM_1)_WIDTH := 32
...
.PHONY: oc_ram_1f
oc_ram_1f: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
