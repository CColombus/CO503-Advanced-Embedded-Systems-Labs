...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../FTOP_MSOC.sopcinfo
...
# Design Name 
# setting SOPC_NAME is FTOP_MSOC
SOPC_NAME := FTOP_MSOC
...
# The SOPC System ID 
# setting SOPC_SYSID is 31
SOPC_SYSID_FLAG += --id=31
ELF_PATCH_FLAG  += --id 31

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x20
SOPC_SYSID_FLAG += --sidp=0x20
ELF_PATCH_FLAG  += --sidp 0x20

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1719041505
SOPC_SYSID_FLAG += --timestamp=1719041505
ELF_PATCH_FLAG  += --timestamp 1719041505
...
# setting hal.stderr is jtag_uart_1f
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_1f

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_1f
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_1f
...
# setting hal.stdout is jtag_uart_1f
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_1f
