...
// ? Original filename was "huffman.c" but it was renamed to "main.c" for consistency
...
// TODO: Here RECV2 must be the pipeline input for this stage.
// TODO: And RECV1 is to get the width, height and count of the macroblocks from q5.txt
