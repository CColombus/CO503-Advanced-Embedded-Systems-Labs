#ifndef _ALTERA_CPU_1E_H_
#define _ALTERA_CPU_1E_H_
...
/*
 * This file contains macros for module 'cpu_1e' and devices
...
/*
 * Macros for module 'cpu_1e', class 'altera_nios2_gen2'.
...
/*
 * Macros for device 'fifo_1e_in_csr', class 'altera_avalon_fifo'
 * The macros are prefixed with 'FIFO_1E_IN_CSR_'.
 * The prefix is the slave descriptor.
 */
#define FIFO_1E_IN_CSR_COMPONENT_TYPE altera_avalon_fifo
#define FIFO_1E_IN_CSR_COMPONENT_NAME fifo_1e
#define FIFO_1E_IN_CSR_BASE 0x8001040
#define FIFO_1E_IN_CSR_SPAN 32
#define FIFO_1E_IN_CSR_END 0x800105f
...
/*
 * Macros for device 'timer_1e', class 'altera_avalon_timer'
 * The macros are prefixed with 'TIMER_1E_'.
 * The prefix is the slave descriptor.
 */
#define TIMER_1E_COMPONENT_TYPE altera_avalon_timer
#define TIMER_1E_COMPONENT_NAME timer_1e
#define TIMER_1E_BASE 0x8001060
#define TIMER_1E_SPAN 32
#define TIMER_1E_END 0x800107f
...
/*
 * Macros for device 'sysid_1e', class 'altera_avalon_sysid_qsys'
 * The macros are prefixed with 'SYSID_1E_'.
 * The prefix is the slave descriptor.
 */
#define SYSID_1E_COMPONENT_TYPE altera_avalon_sysid_qsys
#define SYSID_1E_COMPONENT_NAME sysid_1e
#define SYSID_1E_BASE 0x8001080
#define SYSID_1E_SPAN 8
#define SYSID_1E_END 0x8001087
#define SYSID_1E_ID 30
#define SYSID_1E_TIMESTAMP 1718692765

/*
 * Macros for device 'jtag_uart_1e', class 'altera_avalon_jtag_uart'
 * The macros are prefixed with 'JTAG_UART_1E_'.
 * The prefix is the slave descriptor.
 */
#define JTAG_UART_1E_COMPONENT_TYPE altera_avalon_jtag_uart
#define JTAG_UART_1E_COMPONENT_NAME jtag_uart_1e
#define JTAG_UART_1E_BASE 0x8001088
#define JTAG_UART_1E_SPAN 8
#define JTAG_UART_1E_END 0x800108f
...
/*
 * Macros for device 'fifo_q_5_out', class 'altera_avalon_fifo'
 * The macros are prefixed with 'FIFO_Q_5_OUT_'.
 * The prefix is the slave descriptor.
 */
#define FIFO_Q_5_OUT_COMPONENT_TYPE altera_avalon_fifo
#define FIFO_Q_5_OUT_COMPONENT_NAME fifo_q_5
#define FIFO_Q_5_OUT_BASE 0x8001090
#define FIFO_Q_5_OUT_SPAN 4
#define FIFO_Q_5_OUT_END 0x8001093
...
/*
 * Macros for device 'fifo_1d_out', class 'altera_avalon_fifo'
 * The macros are prefixed with 'FIFO_1D_OUT_'.
 * The prefix is the slave descriptor.
 */
#define FIFO_1D_OUT_COMPONENT_TYPE altera_avalon_fifo
#define FIFO_1D_OUT_COMPONENT_NAME fifo_1d
#define FIFO_1D_OUT_BASE 0x8001094
#define FIFO_1D_OUT_SPAN 4
#define FIFO_1D_OUT_END 0x8001097
...
/*
 * Macros for device 'fifo_1e_in', class 'altera_avalon_fifo'
 * The macros are prefixed with 'FIFO_1E_IN_'.
 * The prefix is the slave descriptor.
 */
#define FIFO_1E_IN_COMPONENT_TYPE altera_avalon_fifo
#define FIFO_1E_IN_COMPONENT_NAME fifo_1e
#define FIFO_1E_IN_BASE 0x8001098
#define FIFO_1E_IN_SPAN 4
#define FIFO_1E_IN_END 0x800109b
