...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../SDR_MSOC.sopcinfo
...
# The SOPC System ID 
# setting SOPC_SYSID is 27
SOPC_SYSID_FLAG += --id=27
ELF_PATCH_FLAG  += --id 27

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001040
SOPC_SYSID_FLAG += --sidp=0x8001040
ELF_PATCH_FLAG  += --sidp 0x8001040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1718692765
SOPC_SYSID_FLAG += --timestamp=1718692765
ELF_PATCH_FLAG  += --timestamp 1718692765
...
# setting hal.stderr is jtag_uart_1b
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_1b

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_1b
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_1b
...
# setting hal.stdout is jtag_uart_1b
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_1b
