...
# Memory: ins_mem_c0
MEM_1 := mpsoc_ins_mem_c0
$(MEM_1)_NAME := ins_mem_c0
...
$(MEM_1)_HIERARCHICAL_PATH := ins_mem_c0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: ins_mem_c0
ins_mem_c0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
