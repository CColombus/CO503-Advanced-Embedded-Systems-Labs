...
# Memory: data_mem_shared
MEM_0 := mpsoc_data_mem_shared
$(MEM_0)_NAME := data_mem_shared
...
$(MEM_0)_HIERARCHICAL_PATH := data_mem_shared
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: data_mem_shared
data_mem_shared: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ins_mem_c1
MEM_1 := mpsoc_ins_mem_c1
$(MEM_1)_NAME := ins_mem_c1
...
$(MEM_1)_HIERARCHICAL_PATH := ins_mem_c1
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: ins_mem_c1
ins_mem_c1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
